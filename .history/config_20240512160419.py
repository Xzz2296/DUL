...
def dul_args_func():
    ...
    parser.add_argument('--model_for_test', type=str, default=r'E:\xpj\research\DUL\checkpoint\density0509\Backbone_IR_SE_64_DUL_Epoch_13_Batch_147836_Time_2024-05-11-07-59_checkpoint.pth')
