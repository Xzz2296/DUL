...
def dul_args_func():
    ...
    parser.add_argument('--model_for_test', type=str, default=r'E:\github\DUL\checkpoints\arcface\Backbone_IR_SE_64_DUL_Epoch_22_Batch_250184_Time_2024-04-05-19-08_checkpoint.pth')
