...
def dul_args_func():
    ...
    parser.add_argument('--model_for_test', type=str, default=r'E:\xpj\research\DUL\checkpoint\density0601\Backbone_IR_SE_64_DUL_Epoch_20_Batch_227440_Time_2024-06-04-10-44_checkpoint.pth')
