...
def dul_args_func():
    ...
    parser.add_argument('--model_for_test', type=str, default=r'E:\xpj\research\DUL\checkpoint\density0515\Backbone_IR_SE_64_DUL_Epoch_22_Batch_250184_Time_2024-05-18-00-39_checkpoint.pth')
