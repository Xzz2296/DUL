...
tensorboard_logdir= os.path.join('./logtensorboard/',current_time)
...
def dul_args_func():
    ...
    parser.add_argument('--trainset_folder', type=str, default='/workspace/DATA/xpj/dataset/DUL/imgs')
    parser.add_argument('--model_save_folder', type=str, default='./checkpoints/density_0622/')
    # parser.add_argument('--log_tensorboard', type=str, default='./logtensorboard/')
    parser.add_argument('--log_tensorboard', type=str, default = tensorboard_logdir)
    ...
    parser.add_argument('--gpu_id', type=str, nargs='+',default=[0,1,2,3,4,5,6])
    ...
    parser.add_argument('--stages', type=str, nargs='+',default=[10,18])
    parser.add_argument('--kl_scale', type=float, default=0.01)
    parser.add_argument('--var_scale', type=float, default=0.5)
    parser.add_argument('--conf_scale', type=float, default=0.5)
